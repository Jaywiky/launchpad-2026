  ...
  return (
    <div className="h-screen w-full bg-[#111111] text-white p-6 overflow-y-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#222222] p-4 rounded-xl border border-[#333333]">
          <h2 className="text-lg font-semibold mb-2">{t('offline_data')}</h2>
          <p className="text-sm text-gray-400">{t('clear_desc')}</p>
          <button
            onClick={() => console.log('[Settings] Clear cached resource data requested')}
            className="mt-4 bg-red-900/30 text-red-400 border border-red-900/50 px-4 py-2 rounded-lg text-sm font-medium"
          >
            {t('clear_data')}
          </button>
        </div>
